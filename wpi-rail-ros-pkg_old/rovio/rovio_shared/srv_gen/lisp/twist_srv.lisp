...
(cl:defmethod cl:initialize-instance :after ((m <twist_srv-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'twist_srv-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rovio_shared-srv:<twist_srv-request> is deprecated: use rovio_shared-srv:twist_srv-request instead.")))

(cl:ensure-generic-function 'linear-val :lambda-list '(m))
(cl:defmethod linear-val ((m <twist_srv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rovio_shared-srv:linear-val is deprecated.  Use rovio_shared-srv:linear instead.")
  (linear m))

(cl:ensure-generic-function 'angular-val :lambda-list '(m))
(cl:defmethod angular-val ((m <twist_srv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rovio_shared-srv:angular-val is deprecated.  Use rovio_shared-srv:angular instead.")
  (angular m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<twist_srv-request>)))
  ...
  (cl:format cl:nil "geometry_msgs/Vector3  linear~%geometry_msgs/Vector3  angular~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%~%float64 x~%float64 y~%float64 z~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'twist_srv-request)))
  "Returns full string definition for message of type 'twist_srv-request"
  (cl:format cl:nil "geometry_msgs/Vector3  linear~%geometry_msgs/Vector3  angular~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%~%float64 x~%float64 y~%float64 z~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <twist_srv-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'twist_srv-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rovio_shared-srv:<twist_srv-response> is deprecated: use rovio_shared-srv:twist_srv-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<twist_srv-response>)))
  ...
  "rovio_shared/twist_srvResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'twist_srv-response)))
  "Returns string type for a service object of type 'twist_srv-response"
  "rovio_shared/twist_srvResponse")
