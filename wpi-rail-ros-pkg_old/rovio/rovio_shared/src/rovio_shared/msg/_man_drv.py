"""autogenerated by genmsg_py from man_drv.msg. Do not edit."""
import roslib.message
import struct


class man_drv(roslib.message.Message):
  _md5sum = "14675853bd9417686a1390c3fb2eaae6"
  _type = "rovio_shared/man_drv"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# Constants for the 'drive' value as defined by the Rovio API
int8 STOP=0
int8 FORWARD=1
int8 BACKWARD=2 
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(man_drv, self).__init__(*args, **kwds)
